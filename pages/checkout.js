                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <ul className="breadcrumb">
                                <li className="breadcrumb-item"><a href="#">User Registration</a></li>
                    ...
                    <div className="row">
                                ...
                                <form className="needs-validation" novalidate>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <div className="invalid-feedback"><style jsx>{` width: 100%; `}</style>Your username is required. </div>
                                        </div>
                                    </div>
                                    <div className="mb-3">
                        ...
                        <div className="col-sm-6 col-lg-6 mb-3">
                            <div className="row">
                                    ...
                                    <div className="shipping-method-box">
                                        ...
                                        <div className="mb-4">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="shippingOption1">Standard Delivery</label> <span className="float-right font-weight-bold">FREE</span>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="shippingOption2">Express Delivery</label> <span className="float-right font-weight-bold">$10.00</span> 
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="shippingOption3">Next Business day</label> <span className="float-right font-weight-bold">$20.00</span> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-12 d-flex shopping-box"> <a href="checkout.html" className="ml-auto btn hvr-hover">Registration</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
